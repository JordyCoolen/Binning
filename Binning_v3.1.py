...
USAGE = 'python Binning_v3 -d datafile -n negativelist -p positivelist -o outputfilename [--bins 0/2/3/4] [--type local/global] [--score 0/1]'
...
#                             print score, res
        ...
        if results_check(res_dict, rankedPN, totalP, totalN):
            ...
            with open(args.output+'.txt', 'w') as out:
                ...
                out.write('binnummer:(indexPN,indexPN,score,leftborder,rightborder)\n')
